<?php 
	$update = $mysqli->query("SELECT * FROM renew_request WHERE uid= $uid AND done = 0");
...
<!-- Default box -->
      <div class="box">
       <form method="post" data-toggle="validator" role="form" id="myform">
        <div class="box-header with-border">
          <h3 class="box-title">Form for Renewal of Concession</h3>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          <label for="prn">Permanent Reg. Number[PRN]</label>
          <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-id-card"></i>
                  </div>
           <input type="text" class="form-control" maxlength="9" value="<?php echo "$prn"; ?>" name="prn" required/>
           </div>
        </div>
      </div>
      <!--  col-md-4 -->
