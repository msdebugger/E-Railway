<?php
    ...
    $stmt = $mysqli->prepare("INSERT INTO apply_request (rid, uid, fname, lname, year, prn, cast, gender, dob, age, address, station, via, class, period, time_stamp, frmfill) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?, ?, ?, ?)");
