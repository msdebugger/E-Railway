...
<html lang="en-IN">
	...
	<body class="hold-transition <?php echo $body_skin; ?> sidebar-mini">
			...
			<div class="content-wrapper">
              <?php require 'includes/global/flash_message.php'; ?>
				...
				<section class="content container-fluid">
					<?php require 'includes/content/editprofile_content.php'; ?>
				</section>
			</div>
        ...
        <script src="../../dist/js/upload.min.js"></script>
        <script src="../../dist/js/jquery.form.js"></script>
        <script src="../../dist/js/bootstrapAlert.min.js"></script>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    if (isset($_POST['update'])) {
        ...
        require 'includes/auth/editprof.php';
