...
<h3 class="box-title">Verify Students Details and Documents</h3>
</div>
<!-- /.box-header -->
<div class="box-body">
<?php
			...
			$sql = mysqli_query($mysqli, "SELECT * FROM apply_request WHERE rid='$rid'");
			if(mysqli_num_rows($sql) == 0){
				header("Location: fresh_verification");
			}else{
