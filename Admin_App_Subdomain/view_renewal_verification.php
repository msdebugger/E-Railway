...
<html>
<head>
  <?php $title = "Renewal Verification"; ?>
  ...
  <div class="content-wrapper">
   ...
   <?php require 'includes/global/flash_message.php'; ?>
    ...
    <section class="content container-fluid">
      ...
      <?php require 'includes/content/content_view_renewal_verification.php'; ?>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    if (isset($_POST['accept'])) {
        ...
        require 'includes/auth/accept_renew.php';
        
    }

    if (isset($_POST['reject'])) {

        require 'includes/auth/reject_renew.php';
        
    }
    
   if (isset($_POST['delete'])) {

        require 'includes/auth/delete_renew.php';
